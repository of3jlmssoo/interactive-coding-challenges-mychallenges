...
def solveks(profits, weights, capacity):
    return ksr(profits, weights, capacity, 0)
...
def ksr(profits, weights, capacity, currentindex):
    global called_num
    called_num += 1
    ...
    result1 = 0
    if (weights[currentindex] <= capacity):
        result1 = profits[currentindex] + ksr(profits,
                                              weights,
                                              capacity - weights[currentindex],
                                              currentindex + 1)
    result2 = ksr(profits, weights, capacity, currentindex + 1)
